...
// ICP Canister connection (placeholder - update with actual canister ID after deploy)
const CANISTER_ID = "rrkah-fqaaa-aaaaa-aaaaq-cai"; // Default from dfx.json local
...
function handleCellClick(index) {
  ...
  // Make move locally (simulated - in real app would call ICP canister)
